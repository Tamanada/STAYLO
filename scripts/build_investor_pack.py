...
.header { background: white; color: var(--ink); padding: 12mm 14mm 8mm; position: relative; border-bottom: 4px solid transparent; border-image: var(--grad-main) 1; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
.header::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 4mm; background: var(--grad-main); -webkit-print-color-adjust: exact; print-color-adjust: exact; }
.header-top { display: flex; align-items: center; justify-content: space-between; gap: 8mm; margin-top: 2mm; }
...
.kpi-strip { background: var(--grad-main); color: white; padding: 7mm 10mm; display: grid; grid-template-columns: repeat(4, 1fr); gap: 3mm; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
.kpi { text-align: center; min-width: 0; }
.kpi-num { font-size: 24px; font-weight: 900; letter-spacing: -1.4px; line-height: 1.1; color: white; white-space: nowrap; text-shadow: 0 1px 2px rgba(0,0,0,0.15); }
.kpi-num.btc { background: linear-gradient(135deg, #FFF7E0, #FFD86F); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent; }
.kpi-label { font-size: 8.5px; font-weight: 700; letter-spacing: 1.1px; text-transform: uppercase; color: rgba(255,255,255,0.85); margin-top: 2mm; line-height: 1.4; }
...
.tile-dark { background: linear-gradient(135deg, #2A1830 0%, #4A1F4D 100%); color: white; padding: 4mm; border-radius: 6px; border: 1.5px solid var(--btc); -webkit-print-color-adjust: exact; print-color-adjust: exact; box-shadow: 0 2px 8px rgba(247,147,26,0.15); }
...
.contact-box { background: var(--grad-main); color: white; border-radius: 8px; padding: 4mm 5mm; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
.contact-name { font-size: 12px; font-weight: 800; }
.contact-role { font-size: 9px; color: rgba(255,255,255,0.85); margin-top: 0.5mm; }
.contact-line { font-size: 9.5px; margin-top: 2mm; line-height: 1.6; }
.contact-line a { color: white; text-decoration: none; border-bottom: 1px solid rgba(255,255,255,0.45); font-weight: 600; }
...
@media print {
  body { background: white; padding: 0; display: block; gap: 0; }
  .page { box-shadow: none; page-break-after: always; }
  .page:last-child { page-break-after: auto; }
  /* Force ALL backgrounds and color treatments to render — Chrome/Edge */
...
{KPI_STRIP}
  <div class="body">
    ...
    <section>
      ...
      <ul>
        <li><strong>OTA fatigue:</strong> 15-25% commissions feel like a tax (Booking 15-18% typical, Agoda 20%, Expedia 20-25%). Hotels want exit, not better integration.</li>
    ...
    <section>
      ...
      <table class="dat">
        ...
        <tbody>
          ...
          <tr><td><strong>Booking.com / Agoda predatory response</strong></td><td>Not a price war (we're 10% vs 17% Booking typical — already won on price). Their response is to negotiate harder with hotels — actually helps our narrative.</td></tr>
