  ...
  return (
    <>
      <SEO
        ...
        description="STAYLO is the booking platform owned by hoteliers. Pay 10% commission instead of Booking.com's 17% — locked for life. Free to join. Launching in Koh Phangan, Thailand."
        path="/"
      />
      <FamilyPopup />
      <Hero />
